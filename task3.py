...
def new_courses(students):
    for i in students:
        if i['course'] == 'python':
            python_['python'].append(i['name'])
        elif i['course'] == 'java':
            java_['java'].append(i['name'])
        elif i['course'] == 'javascript':
            javascript_['javascript'].append(i['name'])
    courses.append(java_)
    courses.append(javascript_)
    courses.append(python_)
    return courses
...
def check_names(names, names_ages):
    for i in names:
        try:
